...
- Match the CV's surname cue on the website: display Lian in small capitals in the name headings and footer, retaining the text “Chen Lian” for copying and accessibility.
...
- Hide the Teaching section on initial page load. Reveal it when the Teaching navigation link targets `#teaching`, including direct links to that section; hide it again when navigating to another section. This must work without JavaScript.
