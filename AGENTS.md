...
- Research navigation should follow Jonathon Hazell's site: pill-shaped single-select topic filters and a separate “Jump to” row linking to Working Papers, Under Revision, and Publications. Topic filters apply across all three groups.
- On wider screens, place the topic buttons directly after the Research heading with a modest gap, with one shared divider underneath. Keep Jump to on its own row below the divider. Place publication-type buttons directly after the Publications heading with a modest gap. Both heading groups are left-aligned and wrap neatly on smaller screens.
