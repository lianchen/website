...
- On wider screens, place the topic buttons beside the Research heading, with one shared divider underneath. Keep Jump to on its own row below the divider. Place publication-type buttons beside the Publications heading. Allow heading rows and buttons to wrap neatly on smaller screens.
